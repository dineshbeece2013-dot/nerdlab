...
const Footer = () => {
  return (
    <footer className="bg-slate-950 border-t border-slate-900 text-slate-400 py-12 px-4 sm:px-6 lg:px-8">
      {/* Four sections on one row, spread by justify-between: the brand sits on
          the left margin, the last list on the right, and the space left over
          is divided equally between them. Equal-width columns do not work here
          because the blocks hold different amounts of text — spreading the
          slack across the gaps keeps the spacing even instead. */}
      {/* One row only from lg up. At 768 the four blocks need more width than
          there is, so the last one overflowed the page; a 2x2 grid carries the
          tablet range instead. */}
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:flex lg:flex-row lg:items-start lg:justify-between gap-10">
        ...
        {/* shrink-0 on the link lists keeps them at their natural width on a
            narrow desktop, so the brand paragraph takes the squeeze rather than
            the link text wrapping onto a second line. */}
        <div className="shrink-0">
          {/* h-8 matches the height of the logo tile in the first column, so all
              four headings sit on one line and all four bodies start together. */}
          <h4 className="text-white text-sm font-semibold mb-4 uppercase tracking-wider h-8 flex items-center">Technologies</h4>
        ...
        <div className="shrink-0">
          <h4 className="text-white text-sm font-semibold mb-4 uppercase tracking-wider h-8 flex items-center">Quick Navigation</h4>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li><Link to="/dashboard" className="hover:text-sky-400 transition-colors">My Dashboard</Link></li>
            <li><Link to="/certificates" className="hover:text-sky-400 transition-colors">Certificates</Link></li>
          </ul>
        </div>

        <div className="shrink-0">
          <h4 className="text-white text-sm font-semibold mb-4 uppercase tracking-wider h-8 flex items-center">Your Account</h4>
          <ul className="space-y-2 text-sm">
            ...
            <li><Link to="/profile" className="hover:text-sky-400 transition-colors">My Profile</Link></li>
            <li><Link to="/forgot-password" className="hover:text-sky-400 transition-colors">Reset Password</Link></li>
          </ul>
        </div>
      </div>
